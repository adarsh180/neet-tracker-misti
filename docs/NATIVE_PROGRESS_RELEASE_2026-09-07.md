...
Candidate verification and promotion details will be appended after deployment. The previous live rollback target is `dpl_B6EJsrWR1wt2ue3X9PWYhMMDRr6c` (runtime source `c610c77`). Private cloned clips stay out of Git and are included only by the existing local Vercel deployment packaging.
