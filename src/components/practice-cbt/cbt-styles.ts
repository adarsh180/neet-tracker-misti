...
export const arenaStyles = `
  ...
  .arena-shell { position: fixed; inset: 0; z-index: 80; background: #eef3f8; color: #1f2937; display: flex; flex-direction: column; font-family: Arial, Helvetica, sans-serif; }
